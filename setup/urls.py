...
urlpatterns = [
    ...
    path(
        'reservatorios/<int:reservatorio_id>/alerta-sonoro/opcoes/',
        views.reservatorio_alerta_sonoro_opcoes,
        name="reservatorio_alerta_sonoro_opcoes",
    ),
    path(
    ...
    path(
        'reservatorios/<int:reservatorio_id>/alerta-sonoro/permanente/',
        views.reservatorio_alerta_sonoro_permanente_alternar,
